<script>
  ...
  import { mdiAccountCircleOutline, mdiClose } from '@mdi/js'
	import { global_USERID, navDrawerActive, notifs } from '$lib/stores/global.store';
...
<div
  class="has-transition z-{$navDrawerActive ? 'n100' : '30'} pos-fix p-2 pos-t-57 pos-r-0 maxmins-h-calc-100vh-65px maxmins-w-400-dt-to-mb-100p has-background-white-bis {!$addTaskPanelActive ? 'rot-y-90' : 'rot-y-0'} rounded-b elevation-4 is-flex is-flex-direction-column"
